extension Cube {
    ...
    public static let solvedEdges: [Edge] = Cube.Edge.Position.allCases.map { position in
    ...
    public static let solvedCorners: [Corner] = Cube.Corner.Position.allCases.map { position in
