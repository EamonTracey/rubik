...
struct Solve: ParsableCommand {
    static var configuration = CommandConfiguration(
        abstract: "Solve a 3x3 cube.",
        discussion: "There are two accepted ways to represent a scrambled cube as a string: character-facelet " +
        "representation or an algorithm.\n\nThe character-facelet representation is a string of length 54 with 6 " +
        "unique characters, each corresponding to a facelet type (sticker color) on the cube. The facelets are " +
        "numbered sequentially left-to-right and top-to-bottom in the following order of faces: up, down, right, " +
        "left, front, back.\n\nYou may also represent a scrambled cube by the algorithm used to scramble it starting " +
        "from the solved state. Algorithm notation accepts U, D, R, L, F, and B to represent clockwise turns of the " +
        "up, down, right, left, front, and back layers, respectively. Appending an apostrophe (\"'\") to a turn " +
        "indicates a counterclockwise turn. Appending a \"2\" to a turn indicates a half (180 degree) turn. Each turn" +
        ...
        "R B2 R U2 L B2 R U' D' R2 F R' L B2 U2 F2"
    )
...
extension Solve {
    static func stringToCube(_ string: String) throws -> Cube {
